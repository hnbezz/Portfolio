...
6. [ Face Expression Recognition. ](#FER)
...
- `CNN_models_training\fer2013.zip`: zip file with the `fer2013.csv` file.
- `CNN_models_training\Benchmark_FER_project.ipynb`: Jupyter notebook used for training the model
- `emotion_demo_final.py`: Script that performs the real-time face expression recognition.
- `trained_models\val_acc_0.68.hdf5`: Model trained using the `CNN_models_training\Benchmark_FER_project.ipynb` notebook.
- `trained_models\haarcascade_frontalface_default.xml`: Face detection model.
...
![Alt text](Face Exp. Recogn/Leaderboard.png?raw=true "Leaderboard")
[What is this]("Face Exp. Recogn\Leaderboard.png")
